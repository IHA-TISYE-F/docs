...
This test verifies that the is able to erase prior defence patterns and usage statistics.
	\subparagraph{Preparations needed:}
	\begin{itemize}
	\item None
	\end{itemize}
...
This test verifies that the technicians are licensed in maintaining the system.
	\subparagraph{Preparations needed:}
	\begin{itemize}
	\item The technicians must have attended and passed the maintenance course provided by Terma A/S. 
	\end{itemize}
...
Requirement: \textit{The chas and ares shall be labeled and packed in
acordance to MIL-STD-2073-1E}\\
	\subparagraph{Preparations needed:}
	\begin{itemize}
	\item None.
	\end{itemize}
