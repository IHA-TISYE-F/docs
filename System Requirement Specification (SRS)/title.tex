...
\\
\end{figure}
\text{\huge System requirement specification (SRS)}\\[0.5cm]
\text{\large Terma case}\\[2cm]

% Title
{ \bfseries Document Identification: F-SRS-2014-V1}\\[2cm]
...
\text{
This document is confidential between company F and the parties involved} \\ 
