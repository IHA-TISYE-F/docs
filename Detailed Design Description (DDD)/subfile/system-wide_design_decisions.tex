...
The system has a built in safety feature which will prevent deployment of the payload when the plane is not airborne. This will be possible by an independent hardware device that measures the distance to the ground. This hardware device cannot be circumvented.
